      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          ...
          <motion.div 
            ...
            className="relative aspect-[4/5] overflow-hidden group shadow-2xl will-change-transform"
          >
            <img 
              src={aboutData.aboutImageUrl} 
              alt="Studio Interior" 
              className="w-full h-full object-cover lg:grayscale transition-[filter,transform] duration-700 group-hover:scale-105 group-hover:grayscale-0"
              loading="lazy"
              decoding="async"
            />
          ...
          >
            ...
            <div className="pt-4">
              <Link to="/location" className="inline-flex items-center gap-4 group">
                <span className="text-sm uppercase tracking-widest font-bold">{t('about_learn_more')}</span>
        ...
        <div className="pt-20 border-t border-border-gray">
          ...
          >
            <span className="text-xs uppercase tracking-[0.4em] text-medium-gray font-bold">{t('about_meet_artists')}</span>
            <h2 className="text-4xl font-heading">{t('about_creative_team')}</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {team.map((member, index) => (
              <motion.div 
                ...
                className="flex flex-col items-center text-center space-y-6 group will-change-transform"
              >
                <div className="relative w-full aspect-[3/4] overflow-hidden lg:grayscale hover:grayscale-0 transition-[filter] duration-700 shadow-xl">
                  <img 
                    src={member.imageUrl} 
                    alt={member.name} 
