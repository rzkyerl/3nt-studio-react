...
const PriceRow = ({ label, price }: { label: string; price: string }) => (
  <div className="flex items-center justify-between py-5 md:py-6 border-b border-border-gray last:border-b-0">
    <p className="text-sm md:text-base uppercase tracking-[0.15em] text-medium-gray">{label}</p>
    ...
    <div className="bg-pure-white text-primary-black">
      <section className="pt-36 pb-16 lg:pt-44 lg:pb-24 border-b border-border-gray">
        <div className="container-custom grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-2xl text-medium-gray font-light max-w-2xl leading-relaxed">
                Professional documentation for events, corporate, and brand activations.
              </p>
            </div>
          ...
          >
            <img src={documentationImage} alt="Documentation service" className="w-full h-full object-cover" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-20 border-b border-border-gray">
        <div className="container-custom space-y-10">
          <div className="space-y-2">
            <h2 className="text-3xl md:text-4xl font-heading font-bold tracking-tight">Photo</h2>
            <p className="text-sm uppercase tracking-[0.2em] text-medium-gray">Output: Data via Google Drive</p>
          </div>
          ...
          <div className="border-y border-border-gray">
            {documentationPhoto.map((item: PriceItem, index: number) => (
              ...
              >
                <PriceRow label={item.label} price={item.price} />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 lg:py-20 border-b border-border-gray">
        <div className="container-custom space-y-10">
          <div className="space-y-2">
            <h2 className="text-3xl md:text-4xl font-heading font-bold tracking-tight">Video</h2>
            <p className="text-sm uppercase tracking-[0.2em] text-medium-gray">Output: Data via Google Drive</p>
          </div>
...
export default DocumentationServicePage;
