...
export const Booking = () => {
  ...
  return (
    <section id="booking" className="section-padding bg-pure-white overflow-hidden">
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          ...
          >
            ...
            {/* Map Embed */}
            <div id="location" className="relative w-full aspect-video bg-light-gray overflow-hidden grayscale border border-border-gray shadow-xl group">
              <iframe
